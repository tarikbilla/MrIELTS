...
export default function WritingTest() {
  ...
  return (
    <>
      <div className="container-fluid p-4 py-8 mx-auto bg-blue-50 dark:bg-gray-800">
                  ...
                  (partNumber, index) => (
                    <li key={partNumber} className="h-auto max-w-full">
                      <Link
                        ...
                        className={`flex items-center px-2 py-4 m-0 text-lg shadow-sm border text-gray-900 font-bold rounded-lg bg-white hover:bg-gray-50 group hover:shadow-md dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white`}
                      >
                        <svg
