          ...
          <div className="block my-8 md:grid grid-cols-2 gap-4">
            <div className="pb-8">
              ...
              <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
                ...
                opportunities. With interactive lessons, practice tests, and
                live speaking sessions, MrIELTS is your dedicated companion on
                the journey to exam success. Start your path to a brighter
                future today.
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            ...
            <div className="w-full max-w-sm p-2 mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <div className="flex flex-col items-center py-4">
                ...
                <h2 className="mb-1 text-2xl my-2 mb-4 font-medium text-gray-900 dark:text-white">
                  Listening
                </h2>
            ...
            <div className="w-full max-w-sm p-2 mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <div className="flex flex-col items-center py-4">
                ...
                <span className="text-sm text-center text-gray-500 dark:text-gray-400">
                  Reading section will help you to test your listening score in
                  online.
                </span>
                <div className="flex mt-4 space-x-3 md:mt-6">
                  <a
            ...
            <div className="w-full max-w-sm p-2 mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <div className="flex flex-col items-center py-4">
                ...
                <span className="text-sm text-center text-gray-500 dark:text-gray-400">
                  Writing section will help you to test your listening score in
                  online.
                </span>
                <div className="flex mt-4 space-x-3 md:mt-6">
                  <a
            ...
            <div className="w-full max-w-sm p-2 mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <div className="flex flex-col items-center py-4">
                ...
                <span className="text-sm text-center text-gray-500 dark:text-gray-400">
                  Speaking section will help you to test your listening score in
                  online.
                </span>
                <div className="flex mt-4 space-x-3 md:mt-6">
                  <a
