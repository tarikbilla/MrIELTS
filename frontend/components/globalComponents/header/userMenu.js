...
export default function Usermenu(){
    return (
        <>
        <button type="button" className="flex mx-3 text-sm bg-gray-400 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
            <span className="sr-only">Open user menu</span>
            <Image height="32" width="32" className="w-8 h-8 rounded-full" src={'/images/user.jpg'} alt="user photo"/>
        </button>
        ...
        <div className="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
            <div className="py-3 px-4">
                <span className="block text-sm font-semibold text-gray-900 dark:text-white">Tarik Billa</span>
                <span className="block text-sm font-light text-gray-500 truncate dark:text-gray-400">tarikbilla@gmail.com</span>
            </div>
